...
# Nomes dos arquivos para salvar o "cérebro" treinado
...
def treinar_modelo(db: Session):
    ...
    # Redes neurais odeiam números em escalas diferentes (ex: Pressão 1000 vs Vento 10)
    ...
    # max_iter=500: Tenta ajustar os pesos 500 vezes
...
def prever_agora(temp_max, temp_min, umidade, pressao, vento):
    ...
    # É importante passar os nomes das colunas para o scaler não reclamar
